...
Create a folder called ***07_Moving the Camera/*** and copy across the contents of your ***06_3D_worlds/*** folder (you will need to have completed [Lab 6: 3D Worlds](3D-worlds-section) before proceeding with this one). Change the filename of ***3D_worlds.js*** to ***moving_the_camera.js*** and edit ***index.html*** so that uses this file.
:::
...
The cubes from [6. 3D Worlds](3D-worlds-section).
```
...
Add the following line of code to after where the `gl` object is creaeted in the ***moving_the_camera.js*** file.
